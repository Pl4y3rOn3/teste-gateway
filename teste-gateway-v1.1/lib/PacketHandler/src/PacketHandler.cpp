...
_SoftwareRevision _packetHandlerRevNumber = {0,0,21};
...
PH_powerState PacketHandler::powerSupply() {
//	Serial.println();
...
PH_powerState PacketHandler::relayState() {
//	Serial.println();
...
//  Serial.printf("%02X", _packet.content.sourceMAC);
  ...
  PH_packetType _typeIndex = this->packetType();
	...
	/*  	  	
				...
				if ( _phMaskPowerVal == PH_POWER_ACTIVE ) {
